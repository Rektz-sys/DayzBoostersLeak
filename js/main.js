      ...
      searchInput.each(function () {
        ...
        searchInput.typeahead(
			 ...
			 // Tools
			 {
			   ...
			   templates: {
				 header: '<h6 class="suggestions-header text-primary mb-0 mx-4 mt-3 pb-2">Tools</h6>',
				 suggestion: function ({ url, icon, name, description }) {
				   return (
					  '<a href="' + url + '">' +
					  '<div>' +
...
const mapConfigs = {
	chernarus: {
		path: '/apps/tools/map/chernarus/tiles/{z}/{x}/{y}.png',
		locationsFile: '/apps/tools/map/chernarus/locations.json',
		initialView: [-128, 128],
		size: 15360
	},
	livonia: {
		path: '/apps/tools/map/livonia/tiles/{z}/{x}/{y}.png',
		locationsFile: '/apps/tools/map/livonia/locations.json',
		initialView: [-128, 128],
		size: 12800
	},
	sakhal: {
		path: '/apps/tools/map/sakhal/tiles/{z}/{x}/{y}.png',
		locationsFile: '/apps/tools/map/sakhal/locations.json',
		initialView: [-128, 128],
		size: 15360 
	}
};
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const excludedNavigationItems = ['Home', 'Latest Files', 'Discord Servers', 'DZB Partners', 'Tools Home'];
  
  sidebarLinks.forEach(link => {
    link.addEventListener('click', function() {
      const toolElement = this.querySelector('[data-tool-name]');
      const toolName = toolElement?.getAttribute('data-tool-name');
      
      if (toolName && 
          !excludedNavigationItems.includes(toolName) && 
          !window.location.pathname.includes('/admin/') && 
          !this.href.includes('/admin/')) {
        trackUsage(toolName);
      }
    });
  });
